...
const exportToExcel = () => {
    ...
    try {
        ...
        const headers = ['Created On', 'SAP DO No', 'Customer Name', 'Customer Acc No', 'Storage Location', 'City', 'State', 'Driver IC', 'Collecter Name', 'Collecter IC', 'Collecter Contact No', 'Collecter Truck Plate', 'Type', 'Pickup Date', 'Status'];
