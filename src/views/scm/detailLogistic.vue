    ...
    <div class="flex flex-col md:flex-row gap-8">
      ...
      <div class="md:w-2/3 flex flex-col">
        ...
        <div class="card flex flex-col gap-6 w-full">
          ...
          <!-- Dealer & Delivery Info Container -->
...
// Assuming you have components like Tag, Button, RouterLink imported globally or in your setup
// import { Tag, Button } from 'your-components-library';

const form = ref({
  status: 0 // Example status, change as needed
});
