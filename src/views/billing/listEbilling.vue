...
const loadFilteredData = async () => {
    ...
    try {
        listData.value = await EBillingService.getEBillingList(dateRange.value[0], dateRange.value[1], customerAccountFilter.value);
        ...
        let filterMessage = `Showing e-billing documents from ${formatDateForDisplay(dateRange.value[0])} to ${formatDateForDisplay(dateRange.value[1])}`;
