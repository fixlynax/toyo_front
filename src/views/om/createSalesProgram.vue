            ...
            <div class="card flex flex-col gap-6 w-full">
                ...
                <div>
                    ...
                    <div v-if="programItems.length > 0" class="space-y-4">
                        <div v-for="(item, index) in programItems" :key="index" class="border rounded-lg p-4 shadow-sm bg-gray-50">
...
const submitForm = () => {
    ...
    console.log('Selected eTEN:', selectedEtenList.value);
};

// Watch for type changes to clear program items
watch(() => salesProgram.value.type, (newType) => {
    programItems.value = [];
});
</script>