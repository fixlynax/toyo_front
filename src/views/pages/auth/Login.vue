...
const images = ['/demo/images/heh.jpeg', '/demo/images/Toyo-Japan-Trip-Day-4-380-scaled.jpg'];
        ...
        <div class="flex w-full md:w-1/3 items-center justify-center p-8 sm:p-10 bg-primary-500">
            <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-6">
                    ...
                    <!-- Login Button -->
                    <Button type="submit" label="Log In" class="w-full bg-primary hover:bg-primary-dark text-white rounded-lg py-3 font-semibold transition" :loading="loading" :disabled="loading" />
                </form>
            </div>
        </div>
    </div>
