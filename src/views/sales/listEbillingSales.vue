                ...
                <div class="text-center py-8 text-gray-500">
                    <template v-if="!hasDateFilterApplied">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <span class="text-lg">Loading e-billing documents...</span>
...
const EBillingService = {
    async getEBillingList(startDate = null, endDate = null, accountNo = null) {
        try {
            let params = {};
...
const loadFilteredData = async () => {
    ...
    try {
        listData.value = await EBillingService.getEBillingList(dateRange.value[0], dateRange.value[1], accountFilterValue);
