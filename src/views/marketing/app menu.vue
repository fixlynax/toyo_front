...
const model = ref([
    ...
    // ===================== Supply Chain Management (SCM / Order Management) =====================
    {
        label: 'SCM',
    ...
    // ===================== HR Management =====================
    // (Currently no HR-related functions exist in this menu)

    // ===================== Report =====================
    // (Reports are nested within Marketing and OM)
]);
</script>
