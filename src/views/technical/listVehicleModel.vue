...
const canUpdate = computed(() => menuStore.canWrite('Vehicle Model List'));
const denyAccess = computed(() => menuStore.canTest('Vehicle Model List'));
...
const fetchExport = async () => {
    try {
        ...
        console.error('error fetching Vehicle Model export:', err);
